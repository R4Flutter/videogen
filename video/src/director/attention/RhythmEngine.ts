...
const tierOf = (dur: number, density: Density): RhythmDecision => {
...
export const rhythmFor = (b: ScriptBeat, facts: BeatFacts[], all: ScriptBeat[]): RhythmDecision => {
  const dur = b.end - b.start;
  const density: Density = b.purpose?.match(/rest|reflect/i)
    ? "low"
    : b.module === "chart" || b.module === "compare" || b.module === "timeline" || b.module === "funnel"
      ? "high"
      : "medium";
  return tierOf(dur, density);
};
